...
void UnitTests::DatabaseTest()
{
    ...
    auto findResults = db->FindProfiles(searchFields, profileToFind, QDate::currentDate(), QDate::currentDate(), Grade(), QDate(), QDate(), true);
    ...
    auto findResults2 = db->FindProfiles(searchFields2, Profile(), QDate(1980, 1, 1), QDate(1990, 1, 1), Grade(), QDate(), QDate(), true);
    ...
    auto findResults3 = db->FindProfiles(searchFields3, Profile(), QDate(), QDate(), gradeToSearch, QDate(), QDate(), true);
    ...
    auto findResults4 = db->FindProfiles(searchFields4, Profile(), QDate(), QDate(), Grade(), QDate(1999, 1, 1), QDate(2003, 1, 1), true);
